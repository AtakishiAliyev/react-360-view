...
// node_modules/react-360-view/dist/index.js
...
var React360Viewer = function(_Component) {
  _inherits(React360Viewer2, _Component);
  var _super = _createSuper(React360Viewer2);
  function React360Viewer2() {
    var _this;
    _classCallCheck(this, React360Viewer2);
    ...
    _this.viewPercentageRef = import_react.default.createRef();
    _this.canvas = null;
    _this.ctx = null;
  ...
  _createClass(React360Viewer2, [{
    ...
    value: function setImage() {
      ...
      if (!cached) {
        ...
        this.currentCanvasImage.onload = function() {
          var viewportElement2 = _this3.viewPortElementRef.getBoundingClientRect();
          _this3.canvas.width = _this3.state.isFullScreen ? viewportElement2.width : _this3.currentCanvasImage.width;
          _this3.canvas.height = _this3.state.isFullScreen ? viewportElement2.height : _this3.currentCanvasImage.height;
    ...
    value: function render() {
      ...
      }, !this.state.imagesLoaded ? import_react.default.createElement("div", {
      ...
      }), this.props.boxShadow ? import_react.default.createElement("div", {
        className: "v360-product-box-shadow"
      }) : ""), import_react.default.createElement("abbr", {
      ...
      }), this.state.panmode ? import_react.default.createElement(button, {
  ...
  return React360Viewer2;
}(import_react.Component);
var dist_default = React360Viewer;
export {
  dist_default as default
};
//# sourceMappingURL=react-360-view.js.map
